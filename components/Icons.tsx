...
export const IconVolumeUp = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 012.25 12c0-.83.112-1.633.322-2.414.235-.847 1.058-1.354 1.938-1.354h2.24z" />
  </svg>
);
...
export const IconUtensils = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25V18a2.25 2.25 0 002.25 2.25h1.5A2.25 2.25 0 0010.5 18V8.25m-6 0H10.5M19.5 8.25v9.75a.75.75 0 01-1.5 0V8.25m1.5 0V3.75a.75.75 0 00-.75-.75H16.5a.75.75 0 00-.75.75v4.5m1.5 0H19.5" />
  </svg>
);
...
export const IconChat = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path
      ...
      d="M7.5 8.25h9m-9 3H12m-9.75 1.51
         c0 1.6 1.123 2.994 2.707 3.227
         1.129.166 2.27.293 3.423.379
         .35.026.67.21.865.501L12 21
         l2.755-4.133a1.14 1.14 0 01.865-.501
         48.172 48.172 0 003.423-.379
         c1.584-.233 2.707-1.626 2.707-3.227
         V6.741
         c0-1.602-1.123-2.995-2.707-3.228
         A48.394 48.394 0 0012 3
         c-2.392 0-4.744.175-7.043.513
         C3.373 3.746 2.25 5.14 2.25 6.741
         v6.018z"
    />
  </svg>
);
...
export const IconMessage = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.625 9.75a.375.375 0 11-.75 0 .375.375 0 01.75 0
         zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0
         zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0
         zm0 0h-.375m-13.5 3.01
         c0 1.6 1.123 2.994 2.707 3.227
         1.129.166 2.27.293 3.423.379
         .35.026.67.21.865.501L12 21
         l2.755-4.133a1.14 1.14 0 01.865-.501
...
export const IconButterfly = ({ className = "w-6 h-6", style }: { className?: string, style?: React.CSSProperties }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
    <path d="M12 4.5c.3 0 .5.3.5.5v1.5a.5.5 0 0 1-1 0V5c0-.2.2-.5.5-.5zm-4.3 2.1c.3-.3.8-.1 1.1.2l.5.6a.5.5 0 0 1-.7.7l-.5-.6c-.3-.3-.4-.8 0-1.1-.1.1.2 0-.4.2zm8.6 0c-.3-.3-.8-.1-1.1.2l-.5.6a.5.5 0 0 0 .7.7l.5-.6c.3-.3.4-.8 0-1.1.1.1-.2 0 .4.2zM8.5 9c-.3 0-.5.2-.5.5v1c0 .3.2.5.5.5h7c.3 0 .5-.2.5-.5v-1c0-.3-.2-.5-.5-.5h-7zm-4.4 2.8c-.2-.2-.2-.6 0-.8l.8-.7c.2-.2.6-.2.8 0l.5.6a.5.5 0 0 0 .8-.6l-.6-.7c-.4-.4-1.2-.4-1.6 0l-.8.7c-.4.4-.4 1.1 0 1.5.1 0 .2.1.2.1-.1 0 0-.1-.1-.1zm15.8 0c.2-.2.2-.6 0-.8l-.8-.7c-.2-.2-.6-.2-.8 0l-.5.6a.5.5 0 0 1-.8-.6l.6-.7c.4-.4 1.2-.4 1.6 0l.8.7c.4.4.4 1.1 0 1.5-.1 0-.2.1-.2.1.1 0 0-.1.1-.1zM6.5 13c-.3 0-.5.2-.5.5v2c0 .3.2.5.5.5h.5c.3 0 .5-.2.5-.5v-2c0-.3-.2-.5-.5-.5h-.5zm11 0c-.3 0-.5.2-.5.5v2c0 .3.2.5.5.5h.5c.3 0 .5-.2.5-.5v-2c0-.3-.2-.5-.5-.5h-.5z" />
    <path fillOpacity="0.4" d="M18.5 8c-1.7 0-3.2.8-4.2 2-1-1.2-2.5-2-4.2-2C6.5 8 4 10.5 4 14c0 1.9 1 3.5 2.5 4.5-.5-1-1-2.5-1-4 0-2.5 1.5-4 3.5-4 1.2 0 2.2.5 3 1.2.8-.7 1.8-1.2 3-1.2 2 0 3.5 1.5 3.5 4 0 1.5-.5 3-1 4 1.5-1 2.5-2.6 2.5-4.5 0-3.5-2.5-6-6-6z" />
  </svg>
);

export const IconWine = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.3-1.067-3.61L5 14.5" />
  </svg>
);

export const IconLightbulb = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-4.5 6.01 6.01 0 00-3 0 6.01 6.01 0 001.5 4.5ZM13.5 4.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0ZM15.75 9c0 3.682-1.614 7.008-4.108 9.375a1.125 1.125 0 01-1.284 0C7.864 16.008 6.25 12.682 6.25 9a6.25 6.25 0 019.5 0Z" />
  </svg>
);
...
export const IconTrophy = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0V5.625a2.25 2.25 0 114.5 0v3.375c0 1.109-.846 2.025-1.921 2.125a4.125 4.125 0 00-1.889 1.875M9.497 14.25V5.625a2.25 2.25 0 00-4.5 0v3.375c0 1.109.846 2.025 1.921 2.125a4.125 4.125 0 011.889 1.875m4.345-4.5a4.125 4.125 0 11-7.252 0 4.125 4.125 0 017.252 0z" />
  </svg>
);
...
export const IconCalendarCheck = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.75h-.375v.008H20.25V6.75zm0 3h-.375v.008H20.25V9.75zm0 3h-.375v.008H20.25V12.75zm0 3h-.375v.008H20.25V15.75zm0 3h-.375v.008H20.25V18.75z" />
  </svg>
);
...
export const IconHistory = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm17.36 2.896c-.355.966-1.058 1.782-1.939 2.244" />
  </svg>
);
