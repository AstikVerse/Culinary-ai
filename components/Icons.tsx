...
export const IconChat = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round""M8.625 9.75h6.75m-6.75 3h4.5m-7.875 6.364
         A9 9 0 113.375 4.636
         a9.003 9.003 0 0117.25 4.114
         c0 2.41-.952 4.62-2.5 6.25L21 21l-6.364-3.886z" />
  </svg>
);
